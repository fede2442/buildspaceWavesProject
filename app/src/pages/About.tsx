    ...
    return <div>
        ...
        <Fragment>
            <Accordion open={open === 1} onClick={() => handleOpen(1)}>
                <AccordionHeader>What is Profit The Ponzi?</AccordionHeader>
                <AccordionBody>
            ...
            <Accordion open={open === 2} onClick={() => handleOpen(2)}>
                <AccordionHeader>How is the random number picked?</AccordionHeader>
                <AccordionBody>
            ...
            <Accordion open={open === 3} onClick={() => handleOpen(3)}>
                <AccordionHeader>Who wins and how much?</AccordionHeader>
                <AccordionBody>
            ...
            <Accordion open={open === 4} onClick={() => handleOpen(4)}>
                <AccordionHeader>When does the lottery end?</AccordionHeader>
                <AccordionBody>
